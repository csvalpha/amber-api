...
SimpleCov.start 'rails' do
  ...
  add_filter 'lib/capistrano/slack.rb'
...
VCR.configure do |config|
  ...
  config.filter_sensitive_data('MAILGUN_BASIC_AUTH') do
    Base64.strict_encode64("api:#{Rails.application.config.x.mailgun_validation_key}")
  end
end
